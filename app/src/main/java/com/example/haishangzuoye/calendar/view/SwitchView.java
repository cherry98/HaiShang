...
public class SwitchView extends View {
	...
	private final AccelerateDecelerateInterpolator aInterpolator2 = new AccelerateDecelerateInterpolator();
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        RadialGradient shadowGradient = new RadialGradient(bWidth/2, bWidth/2, bWidth/2, 0xff000000, 0x00000000,
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(isOn ? Color.parseColor("#23ca75") : 0xffc0c0c0);
...
//		postInvalidate();
	...
	/**
	 * if set true , the state change to on; if set false, the state change to
	 * off
	 * 
	 * @param isOpened
	 */
